        ...
        !(function (t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                (l = c),
                    ...
                    l &&
                        c &&
                        (Ot(e[h], 0, on) ? (i[h] = i[h + 1] = 0) : ((o = i[h] / e[h]), (s = i[h + 1] / e[h]), (r = Math.pow(o, 2) + Math.pow(s, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h]))));
        })(t, i, n),
            (function (t, e) {
                const i = t.length;
                let n,
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (r = 0; r < n; ++r)
                (a = t.getDatasetMeta(r)),
                    (l = a.dataset),
                    (c = null),
                    l && l.options && l instanceof vo && (c = { visible: t.isDatasetVisible(r), index: r, fill: zo(l, r, n), chart: t, scale: a.vScale, line: l }),
                    (a.$filler = c),
                    s.push(c);
    ...
    class ps extends Oi {
        ...
        drawBody(t, e, i) {
            ...
            for (
                ...
                for (m = o[_], x = n.labelTextColors[_], e.fillStyle = x, J(m.before, g), b = m.lines, r && b.length && (n._drawColorBox(e, t, _, f, i), (d = Math.max(h.lineHeight, l))), y = 0, M = b.length; y < M; ++y)
