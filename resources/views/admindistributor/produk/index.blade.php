	...
	<div class="col-lg-12 mb-lg-0 mb-4">
		<div class="card z-index-2 h-100">
			...
			<div class="card-body p-3">
				{{ Form::open(['route'=>'admindistributor.product.store','method'=>'POST','files'=>true]) }}
				...
				<table id="idsuperadminaddverifikator" class="table table-striped table-bordered" style="width:100%">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								{{ Form::model($produk, ['route'=>['admindistributor.product.destroy',$produk->id]]) }}
									<a href="{{ route('admindistributor.product.edit',$produk->id) }}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
									@method('DELETE')
