        ...
        <div class="container">
          ...
          <div class="atas">
            <div class="gambar">
              <div class="img-produk">
                <img src="{{asset('foto_produk/' . $produk->foto_produk )}}" class="img-produk" alt="foto-produk"/>
              </div>
            </div>
            ...
            <div
              ...
              <div class="detil my-4 ms-3" style="font-weight: 600;">
                ...
                <p>Pendiri : {{ $produk->pendiri }} </p>
                <p>Berdiri sejak: {{ $produk->berdiri_sejak }} </p>
                <p>Kategori : <a href="\kategori" class="tautan link-dark" style="text-decoration: none">{{ $produk->kategori->jenis_kategori }}</a> </p>
                <p>Situs web : {{ $produk->situs_web }} </p>
                <p>Sosial media : {{ $produk->sosial_media }} </p>
              </div>
            ...
            <div class="qrcode text-center">
              <img src="{{asset('img/qrcode.png')}}" alt="" class="img-fluid" />
              <p class="caps">
          ...
          <div class="desk col-12">
            <p style="font-weight: 400; font-size: 20">
              ...
              {{-- <br> Lorem ipsum dolor sit amet consectetur adipisicing elit. At
