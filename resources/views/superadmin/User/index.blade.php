	...
	<div class="col-lg-12 mb-lg-0 mb-4">
		<div class="card z-index-2 h-100">
			<div class="card-header pb-0 pt-3 bg-transparent">
				<h6 class="text-capitalize">Admin Distributor</h6>
			</div>
			<div class="card-body p-3">
				{{ Form::open(['route'=>'superadmin.admin_dis.store','method'=>'POST','files'=>true]) }}
					...
					<div class="form-group">
						<button type="submit" class="btn btn-primary btn-sm w-100 mb-3">Tambah Admin Distributor</button>
					</div>
				{{ Form::close() }}
			</div>
		</div>
...
<div class="row mt-4">
	<div class="col-lg-12 mb-lg-0 mb-4">
		<div class="card z-index-2 h-100">
			<div class="card-body p-3">
				<table id="idsuperadminadddistributor" class="table table-striped table-bordered" style="width:100%">
					<thead>
						<tr>
							<th>No.</th>
							<th>Name</th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								{{ Form::model($user, ['route'=>['superadmin.admin_dis.destroy',$user->id]]) }}
									{{-- <a href="{{ route('superadmin.admin_dis.edit',$user->id) }}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a> --}}
									@method('DELETE')
